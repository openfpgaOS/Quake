...
================
*/
PQ_HOT void R_AliasSetUpTransform (int trivial_accept)
{
	int				i;
...
================
*/
PQ_HOT void R_AliasTransformFinalVert (finalvert_t *fv, auxvert_t *av,
	trivertx_t *pverts, stvert_t *pstverts)
{
#if HW_ALIAS_MAC
...
================
*/
PQ_HOT void R_AliasTransformAndProjectFinalVerts (finalvert_t *fv, stvert_t *pstverts)
{
	int			i;
	trivertx_t	*pverts;
#if !HW_ALIAS_MAC
...
================
*/
PQ_HOT void R_AliasDrawModel (alight_t *plighting)
{
